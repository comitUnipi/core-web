    ...
    <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12">
      <div className="lg:col-span-5 py-12 md:px-12 md:py-32 flex items-center justify-center">
        <div className="max-w-sm">
          <h1 className="text-5xl mb-6 font-display text-primary font-semibold leading-tight">
          ...
          <Link
            ...
            className="flex items-center mt-8 text-sm text-white font-semibold"
          >
      ...
      <div className="lg:col-span-7 relative h-52 md:h-72 lg:h-auto">
        ...
        <div className="absolute bottom-0 right-0 grid grid-cols-2">
          <button
            className="p-4 md:p-6 rounded-tl-md bg-white hover:bg-gray-100 hover:opacity-80"
            onClick={prevSlide}
          >
            <IoIosArrowBack />
          </button>
          <button
            className="p-4 md:p-6 bg-white hover:bg-gray-100 hover:opacity-80"
            onClick={nextSlide}
          >
            <IoIosArrowForward />
          </button>
