  ...
  return (
    <div className="container mx-auto px-6 flex justify-between items-center py-4 h-32">
      <div className="flex items-center h-full">
        <Link
          href="/"
          className="text-2xl font-bold text-primary tracking-tighter h-full flex items-center"
        >
          COMIT
        </Link>
        <div className="hidden lg:flex items-center text-xs uppercase tracking-wider ml-4">
          ...
          <button
            ...
            type="button"
            className="uppercase ml-8 hover:underline hover:scale-110 transition-all"
          >
            Kontak
          </button>
        </div>
      </div>
      <ToggleNavbar show={showContactInfo} toggleFunction={toggleContactInfo}>
