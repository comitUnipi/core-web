...
export const Mentoring = () => {
  ...
  return (
    <main className="h-auto md:h-screen">
      ...
      >
        Kami mempunyai beberapa mentor yang sudah berpengalaman di bidangnya
        masing-masing
      </motion.h2>
      <div className="container mx-auto h-auto lg:ml-60 xl:ml-96">
        <ol className="relative border-s border-gray-200">
          ...
          >
            ...
            <h1 className="mb-1 text-xl font-normal leading-none text-blue-600">
              Mentor Programming
            </h1>
            <div className="items-center block p-3">
              <motion.div
                ...
                <div className="flex gap-2 items-center">
                  <motion.div whileHover="hover" variants={iconVariants}>
                    <Link
                      ...
                      href="https://www.instagram.com/idham_mubarok"
                    >
                  ...
                  <motion.div whileHover="hover" variants={iconVariants}>
                    <Link
                      className="mt-3 flex items-center gap-2 text-sm"
                      href="https://www.linkedin.com/in/idham-mubarok-71543b171/"
                    >
                  ...
                  <motion.div whileHover="hover" variants={iconVariants}>
                    <Link
                      className="mt-3 flex items-center gap-2 text-sm"
                      href="https://web.facebook.com/idam.mubarok"
                    >
              ...
              <div className="text-gray-600 mt-5">
                ...
                <div className="flex gap-2 items-center">
                  <motion.div whileHover="hover" variants={iconVariants}>
                    <Link
                      className="mt-3 flex items-center gap-2 text-sm"
                      href="https://www.instagram.com/adnr_id"
                    >
                      <FaInstagram size={28} className="text-rose-500" />
                    </Link>
                  </motion.div>
                  <motion.div whileHover="hover" variants={iconVariants}>
                    <Link
                      className="mt-3 flex items-center gap-2 text-sm"
                      href="https://www.linkedin.com/in/aditya-anwary-graphic-designer-a6486b1b2/"
                    >
                      <FaLinkedin size={28} className="text-blue-500" />
                    </Link>
                  </motion.div>
