    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-4 px-4">
                <div className="block w-full md:flex-1 lg:max-w-xs mb-12">
                    <Image src="/2.jpeg" alt='Foto Mentor' width={200} height={200} className="w-full rounded-md h-96 object-cover" />
                    <div className="text-lg text-center p-4">Nama Mentor</div>
                    <div className="w-full sm:w-auto flex items-center justify-center px-6 mb-5">
